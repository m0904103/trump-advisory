...
function App() {
  ...
  // Force update version: 'vAuto_20260921_1103'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260921_1103') return '15.00';
    return localStorage.getItem('twVix') || '21.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260921_1103') return '14.88';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260921_1103');
  }, [twVix, usVix]);
