...
function App() {
  ...
  // Force update version: 'vAuto_20260917_1743'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260917_1743') return '26.74';
    return localStorage.getItem('twVix') || '21.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260917_1743') return '15.66';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260917_1743');
  }, [twVix, usVix]);
