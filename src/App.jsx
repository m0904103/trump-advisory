...
function App() {
  ...
  // Force update version: 'vAuto_20260903_1003'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260903_1003') return '26.63';
    return localStorage.getItem('twVix') || '30.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260903_1003') return '15.28';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260903_1003');
  }, [twVix, usVix]);
