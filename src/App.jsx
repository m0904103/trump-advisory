...
function App() {
  ...
  // Force update version: 'vAuto_20260903_0212'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260903_0212') return '23.14';
    return localStorage.getItem('twVix') || '30.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260903_0212') return '15.20';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260903_0212');
  }, [twVix, usVix]);
