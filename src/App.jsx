...
function App() {
  ...
  // Force update version: 'vAuto_20260921_0230'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260921_0230') return '15.09';
    return localStorage.getItem('twVix') || '21.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260921_0230') return '14.81';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260921_0230');
  }, [twVix, usVix]);
