...
function App() {
  ...
  // Force update version: 'vAuto_20260922_1017'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260922_1017') return '15.00';
    return localStorage.getItem('twVix') || '21.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260922_1017') return '14.80';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260922_1017');
  }, [twVix, usVix]);
