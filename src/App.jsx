...
function App() {
  ...
  // Force update version: 'vAuto_20260924_1028'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260924_1028') return '15.00';
    return localStorage.getItem('twVix') || '21.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260924_1028') return '16.31';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260924_1028');
  }, [twVix, usVix]);
