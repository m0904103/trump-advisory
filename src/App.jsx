...
function App() {
  ...
  // Force update version: 'vAuto_20260824_2045'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260824_2045') return '32.03';
    return localStorage.getItem('twVix') || '30.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260824_2045') return '15.87';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260824_2045');
  }, [twVix, usVix]);
