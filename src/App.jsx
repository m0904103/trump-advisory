...
function App() {
  ...
  // Force update version: 'vAuto_20260831_1148'
  const [twVix, setTwVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260831_1148') return '26.80';
    return localStorage.getItem('twVix') || '30.50';
  });
  const [usVix, setUsVix] = useState(() => {
    if (localStorage.getItem('vixVersion') !== 'vAuto_20260831_1148') return '15.23';
  ...
  useEffect(() => { 
    ...
    localStorage.setItem('vixVersion', 'vAuto_20260831_1148');
  }, [twVix, usVix]);
